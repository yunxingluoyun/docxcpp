...
int main() {
  ...
  created.set_paragraph_alignment(4, docxcpp::ParagraphAlignment::Justify);
  ...
  created.add_picture(image_path, image_size);
  ...
  assert(paragraphs[2].text() == "mix-ed");
  assert(paragraphs[2].alignment() == docxcpp::ParagraphAlignment::Left);
  assert(!paragraphs[2].has_page_break());
  assert(paragraphs[2].runs().size() == 2);
  assert(paragraphs[2].runs()[0].text() == "mix-");
  assert(paragraphs[2].runs()[0].style().bold);
  assert(paragraphs[2].runs()[0].style().color_hex == "008800");
  assert(paragraphs[2].runs()[1].text() == "ed");
  ...
  assert(paragraphs[3].runs()[0].text() == "\n");
  assert(paragraphs[3].runs()[0].style().font_size_pt == 0);
  assert(paragraphs[4].text() == " beta \nline 2");
  assert(paragraphs[4].alignment() == docxcpp::ParagraphAlignment::Right);
  assert(!paragraphs[4].first_run_style().bold);
  assert(paragraphs[4].first_run_style().italic);
  assert(paragraphs[4].first_run_style().underline);
  assert(paragraphs[4].first_run_style().font_size_pt == 14);
  assert(paragraphs[4].first_run_style().font_name == "Courier New");
  assert(paragraphs[4].first_run_style().color_hex == "AA2200");
  assert(paragraphs[4].first_run_style().highlight == "green");
  assert(!paragraphs[4].has_page_break());
  assert(paragraphs[4].style_id().empty());
  assert(paragraphs[4].heading_level() == -1);
  assert(paragraphs[4].runs().size() == 1);
  assert(paragraphs[4].runs()[0].text() == " beta \nline 2");
  assert(paragraphs[4].runs()[0].style().italic);
  assert(paragraphs[4].runs()[0].style().underline);
  assert(paragraphs[4].runs()[0].style().font_name == "Courier New");
  assert(paragraphs[5].text() == "Section");
  assert(paragraphs[5].alignment() == docxcpp::ParagraphAlignment::Justify);
  assert(paragraphs[5].style_id() == "Heading1");
  assert(paragraphs[5].heading_level() == 1);
  assert(paragraphs[5].runs().size() == 1);
  assert(paragraphs[5].runs()[0].text() == "Section");
  ...
  assert(xml.find("w:pgSz w:w=\"11900\" w:h=\"16840\"") != std::string::npos);
  assert(xml.find("w:pgMar w:top=\"1440\" w:right=\"1080\" w:bottom=\"1440\" w:left=\"1080\"") !=
         std::string::npos);
